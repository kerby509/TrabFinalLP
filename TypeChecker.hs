...
typeof _ BNull = Just TNull
typeof _ (Num _) = Just TNum
typeof ctx (Add e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                           (Just TNum, Just TNum) -> Just TNum
                           _                       -> Nothing 
-- Tipo de retorno
typeof ctx (Subs e1 e2) = case (typeof ctx e1, typeof ctx e2) of 
                           (Just TNum, Just TNum) -> Just TNum
                           _                       -> Nothing 
...
typeof ctx (Igual e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                            ...
                            (Just TNum, Just TNum) -> Just TBool
                            _ -> Nothing
typeof ctx (Maiores e1 e2) = case (typeof ctx e1, typeof ctx e2) of
                            (Just TNum, Just TNum) -> Just TBool
                            _ -> Nothing
...
typeof ctx (RPrimeiro e) = case typeof ctx e of 
                            Just (TPair t1 t2) -> Just t1
                            _                  -> Nothing
typeof ctx (RSegundo e) = case typeof ctx e of
